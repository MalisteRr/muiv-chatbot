...
**Telegram:** [@DeepFAQ_Bot](https://t.me/DeepFAQ_Bot)
...
**Что можно улучшить:**
- [ ] Добавить unit-тесты
- [ ] Интеграция с другими мессенджерами (WhatsApp, VK)
- [ ] Web-интерфейс для управления FAQ
...
**Михаил (MalisteRr)**
- GitHub: [@MalisteRr](https://github.com/MalisteRr)
- Telegram: [@MalisteRr](https://t.me/MalisteRr)

Выпускная квалификационная работа (ВКР) 2025
